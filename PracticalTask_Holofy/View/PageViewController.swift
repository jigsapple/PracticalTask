...
class PageViewController: UIViewController {
    ...
    @objc func presentLocationListViewController() {
        guard let locationListViewController = mainStroryboard.instantiateViewController(withIdentifier: LocationsViewController.identifier) as? LocationsViewController else {
            return
        }
